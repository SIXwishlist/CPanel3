...
browser.initSettings = function() {
    ...
    //$('#order input[value="' + _.kuki.get('order') + '"]').get(0).checked = true;//orginal
    if($('#order input[value="' + _.kuki.get('order') + '"]').length)
        $('#order input[value="' + _.kuki.get('order') + '"]').get(0).checked = true;//replacement
    ...
    if($('#view input[value="' + _.kuki.get('view') + '"]').length)
        $('#view input[value="' + _.kuki.get('view') + '"]').get(0).checked = true;
