...
/** Arabic localization file for KCFinder
  * translation by: Ahmad Alselwadi <ahmad.alselwadi@gmail.com>
  */

$lang = array(

    '_locale' => "ar_AR.UTF-8",  // UNIX localization code
    ...
    "ليست لديك الصلاحية لتحميل الملفات.",

    "You don't have permissions to browse server." =>
    "ليست لديك الصلاحية لتصفح الملفات.",

    "Cannot move uploaded file to target folder." =>
    "لا يمكن نقل الملف المرفوع إلى الحافظة المطلوبة.",

    "Unknown error." =>
    "خطأ غير معروف.",

    "The uploaded file exceeds {size} bytes." =>
    "الملف المرفوع تجاوز الحد المسموح به {size} بايت.",

    "The uploaded file was only partially uploaded." =>
    "الملف المرفوع لم يتم تحميله بالكامل.",
