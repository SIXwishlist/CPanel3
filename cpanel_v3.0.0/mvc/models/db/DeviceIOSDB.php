...
/**
 * Description of DeviceIOSDB
 *
 * @author Ahmad
 */
class DeviceIOSDB extends DataDB {
    ...
    public static function add_device($device){
        ...
        try {
            ...
            $params = array( $device->device_token, $device->phone, $device->created, $device->app_id );
            
            $query = "INSERT INTO `devices_ios` ( `device_token`, `phone`, `created`, `app_id` ) "
                . " VALUES ( ?, ?, ?, ? ) ";
    ...
    public static function update_device($device){
        ...
        try {
            ...
            $query = "UPDATE `devices_ios` SET "
                ."  `device_token` = ?, `phone` = ?, `created` = ?, `app_id` = ? "
    ...
    public static function remove_device($device){
        ...
        try {
            ...
            $query = "DELETE FROM `devices_ios` WHERE `dev_id` = ".$device->dev_id;
    ...
    public static function get_devices($app_id = -1, $start = -1, $count = -1, $order_by = '`dev_id`', $arrange = 'ASC'){
        ...
        try {
            ...
            $query = "SELECT * FROM `devices_ios` WHERE 1 ";
    ...
    public static function get_devices_count($app_id){
        ...
        try {
            ...
            $query = "SELECT COUNT(*) AS `count` FROM `devices_ios` WHERE 1 ";
    ...
    public static function add_or_update_device($device){
        ...
        try {
            ...
            $params = array(
                $device->device_token, $device->phone, $device->created, $device->app_id,
                $device->device_token, $device->phone, $device->created, $device->app_id
            );
            ...
            $query = "INSERT INTO `devices_ios` ( `device_token`, `phone`, `created`, `app_id` ) "
                   ...
                   . " UPDATE `device_token` = ?, `phone` = ?, `created` = ?, `app_id` = ? ";
    ...
    public static function get_device($dev_id){
        ...
        try {
            ...
            $query = "SELECT * FROM `devices_ios` WHERE "
                ." `dev_id` = ".$dev_id;
