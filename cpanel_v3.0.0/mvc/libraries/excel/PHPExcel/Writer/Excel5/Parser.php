...
//		$volatile = $this->_functions[$token][3];
	 ...
	 * @param int		$division
	 */
	function _convertRange2d($range, $division=0)
	{
		...
		if ($division == 0) {
			...
			// TODO: use real error codes
			throw new PHPExcel_Writer_Exception("Unknown class $division");
		}
	...
	{
//		$division = 0; // formulas like Sheet1!$A$1:$A$2 in list type data validation need this class (0x3B)
...
//		}
	...
	{
//		$division = 2; // as far as I know, this is magick.
