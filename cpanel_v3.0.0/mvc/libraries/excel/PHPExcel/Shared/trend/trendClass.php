		...
		switch ($trendType) {
			...
			case self::TREND_POWER :
				if (!isset(self::$_trendCache[$key])) {
					$divisionName = 'PHPExcel_'.$trendType.'_Best_Fit';
					self::$_trendCache[$key] = new $divisionName($yValues,$xValues,$const);
				}
			...
			case self::TREND_BEST_FIT_NO_POLY	:
				...
				foreach(self::$_trendTypes as $trendMethod) {
					$divisionName = 'PHPExcel_'.$trendMethod.'BestFit';
					$bestFit[$trendMethod] = new $divisionName($yValues,$xValues,$const);
