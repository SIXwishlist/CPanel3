...
/**
 * Description of CheckoutDisplay
 *
 * @author Ahmad
 */
...
class CheckoutDisplay {
    ...
    public static function get_checkout(){
        ...
        try {
            ...
            $layout->title  = Dictionary::get_text('Checkout_lbl') . ' | ' . $layout->title_postfix;
            $layout->tags[] = array( "name" => "keywords"   , "content" => Dictionary::get_text('Checkout_lbl') );
            $layout->tags[] = array( "name" => "description", "content" => Dictionary::get_text('Checkout_lbl') );
            ...
            $front_tpl = TplLoader::get_tpl_data('checkout.tpl.php', 'mvc/views/pages', $page_data);

            $main_data["lang_ar"] = UrlUtil::get_checkout_href("ar");
            $main_data["lang_en"] = UrlUtil::get_checkout_href("en");
