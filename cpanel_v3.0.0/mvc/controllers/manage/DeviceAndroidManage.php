...
/**
 * Description of DeviceAndroidManage
 *
 * @author Ahmad
 */

class DeviceAndroidManage {
    ...
    public static function add_device(){
        ...
        try {
            ...
            if( $permitted ){
                ...
                $status = DeviceAndroidDB::add_device($device);
    ...
    public static function update_device(){
        ...
        try {
            ...
            if( $permitted ){
                ...
                //$old_device = DeviceAndroidDB::get_device($device_id);
                
                $status = DeviceAndroidDB::update_device($device);
    ...
    public static function remove_device(){
        ...
        try {
            ...
            if( $permitted ){
                ...
                $device    = DeviceAndroidDB::get_device($device_id);

                $status    = DeviceAndroidDB::remove_device($device);
    ...
    public static function get_devices(){
        ...
        try {
            ...
            if( $permitted ){
                ...
                $devices      = DeviceAndroidDB::get_devices($index, $count);
                $result_count = DeviceAndroidDB::get_devices_count();
    ...
    public static function search_devices(){
        ...
        try {
            ...
            if( $permitted ){
                ...
                $devices      = DeviceAndroidDB::search_devices($device_params, $index, $count, '`device_id`', 'ASC');
                $result_count = DeviceAndroidDB::search_devices_count($device_params);
    ...
    public static function import_devices(){
        ...
        try {
            ...
            if( $permitted ){
                ...
                $status = DeviceAndroidDB::add_devices_list($device_records);
    ...
    private static function get_formated_object($device){
        ...
        $device_object['reg_id']    = $device->reg_id;
    ...
    private static function read_device_form(){
        ...
        try {
            ...
            $device_arr['reg_id']  = $request->get_parameter("reg_id");
